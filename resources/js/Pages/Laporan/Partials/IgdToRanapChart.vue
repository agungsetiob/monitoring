...
const renderChart = () => {
    ...
    const labels = props.data.map(row => dayjs(row.tanggal).format('DD/MM/YYYY'));
...
const exportChartAsImage = () => {
    ...
    link.download = 'igd-to-ranap-' + props.data[0].tanggal + '.png';
    link.click();
};
...
<template>
    <div class="bg-white p-6 rounded-xl shadow-md border border-gray-200">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-bold text-gray-800">📅 Lanjut Rawat Inap</h2>
